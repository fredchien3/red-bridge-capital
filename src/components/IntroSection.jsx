...
export default function IntroSection() {
  return (
    <>
      <header className="w-full h-3/5 relative flex justify-center items-center -z-10" style={{ transformStyle: 'preserve-3d' }}>
        <div
      ...
      <section className="flex justify-between h-2/5 font-ss">
